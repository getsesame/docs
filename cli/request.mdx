...
<Note>
  The first time you send a request to a hostname, the broker pauses and waits for you to approve it. You will receive an approval prompt in the Sesame dashboard or via your configured Telegram notification. Tap **Approve** to allow the request and establish the policy for that hostname. All subsequent requests to the same hostname use the cached policy and proceed without interruption.
</Note>
