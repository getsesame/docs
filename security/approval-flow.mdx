...
description: "Sesame requires your approval the first time an agent accesses any new hostname. Approve or deny via the app, dashboard, or Telegram in real time."
---
