...
description: "Sesame requires your approval the first time an agent accesses any new hostname. Approve or deny via the dashboard or Telegram in real time."
---
...
<Steps>
  ...
  <Step title="No policy found — notification sent">
    If no matching policy exists, the broker holds the request and immediately sends you an approval notification via the Sesame mobile app or Telegram, whichever you have configured.
  </Step>
...
Sesame supports two channels for real-time approval notifications. Configure one or both in your account settings.
