...
Therefore: if you're doing the **optional** panel change in step 2, do it **before any container work** — a later recreate silently deletes your install (see [Troubleshooting](#troubleshooting), row 4).
