# Source: https://github.com/getsesame

[README.md](https://github.com/getsesame/.github/tree/main/profile/README.md)
...
1. [sesame](https://github.com/getsesame/sesame) sesame Public
 
 Sesame CLI — proxy authenticated HTTP requests through a user-controlled broker so AI agents never see credentials. Install: curl -fsSL https://getsesame.dev/install.sh | sh
 
 Shell
 
2. [skills](https://github.com/getsesame/skills) skills Public
 ...
 Python [1](https://github.com/getsesame/skills/forks)
...
Type All Public Sources Forks Archived Mirrors TemplatesLanguage All Python ShellSort Last updated Name Stars

Showing 3 of 3 repositories

- [sesame](https://github.com/getsesame/sesame) Public
 ...
 [**Uh oh!**](https://github.com/getsesame/sesame/graphs/commit-activity)
 
 [There was an error while loading.](https://github.com/getsesame/sesame/graphs/commit-activity) [Please reload this page]().
 
 getsesame/sesame’s past year of commit activity
 
 Shell 0 0 [0](https://github.com/getsesame/sesame/issues) [0](https://github.com/getsesame/sesame/pulls) Updated Jun 18, 2026
 
- [skills](https://github.com/getsesame/skills) Public
 
 Agent skills for Sesame. Teach your AI agent (Claude Code, Codex, Cursor, +42 more) to call APIs through your Sesame broker via \`sesame request\` — install with: npx skills add getsesame/skills
 
 [**Uh oh!**](https://github.com/getsesame/skills/graphs/commit-activity)
 
 [There was an error while loading.](https://github.com/getsesame/skills/graphs/commit-activity) [Please reload this page]().
 
 getsesame/skills’s past year of commit activity
 
 Python 0 [1](https://github.com/getsesame/skills/forks) [0](https://github.com/getsesame/skills/issues) [0](https://github.com/getsesame/skills/pulls) Updated Jun 15, 2026
 
- [.github](https://github.com/getsesame/.github) Public
 
 Org-level profile for getsesame — see profile/README.md
 
 [**Uh oh!**](https://github.com/getsesame/.github/graphs/commit-activity)
 
 [There was an error while loading.](https://github.com/getsesame/.github/graphs/commit-activity) [Please reload this page]().
 
 getsesame/.github’s past year of commit activity
 
 0 0 [0](https://github.com/getsesame/.github/issues) [0](https://github.com/getsesame/.github/pulls) Updated Apr 30, 2026
 

[**People**](https://github.com/orgs/getsesame/people)
